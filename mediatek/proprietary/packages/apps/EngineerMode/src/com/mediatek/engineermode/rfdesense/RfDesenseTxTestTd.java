...
public class RfDesenseTxTestTd extends RfDesenseTxTestBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ModemCategory.getModemType() == ModemCategory.MODEM_TD) {
            mBandValues = getResources().getStringArray(R.array.rf_desense_tx_test_td_band_values);
        } else {
            mBandValues = getResources().getStringArray(R.array.rf_desense_tx_test_fd_band_values);
        }
        ...
        Button.OnClickListener listener = new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                case R.id.button_start:
                    ...
                    String band;
                    band = mBandValues[mBand.getSelectedItemPosition()];
