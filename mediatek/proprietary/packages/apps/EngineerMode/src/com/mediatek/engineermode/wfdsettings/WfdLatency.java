...
public class WfdLatency extends Activity {
    ...
    private void registerContentObserver() {
        mWifiObserver = new WifiContentObserver(mHandler);
        Uri mUri = Settings.Global.getUriFor(Settings.Global.WIFI_DISPLAY_WIFI_INFO);
        getContentResolver().registerContentObserver(mUri, true, mWifiObserver);
        mLatencyObserver = new LatencyContentObserver(mHandler);
        mUri = Settings.Global.getUriFor(Settings.Global.WIFI_DISPLAY_WFD_LATENCY);
    ...
    private class WifiContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            Elog.v(TAG, "WifiContentObserver - onChange" + selfChange);
    ...
    private class LatencyContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            super.onChange(selfChange);
            Elog.v(TAG, "LatencyContentObserver - onChange" + selfChange);
