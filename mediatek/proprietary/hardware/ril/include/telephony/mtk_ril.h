...
#define RIL_REQUEST_RETRIEVE_HELD_CALL (RIL_REQUEST_VENDOR_BASE + 109)
/// @}
...
/// M: ViLTE feature. @{
#define RIL_REQUEST_SET_VT_CAPABILITY (RIL_REQUEST_VENDOR_BASE + 114)
#define RIL_REQUEST_VT_DIAL (RIL_REQUEST_VENDOR_BASE + 115)
#define RIL_REQUEST_VOICE_ACCEPT (RIL_REQUEST_VENDOR_BASE + 116)
/// @}
...
/// M: [C2K] MD IRAT feature. @{
#define RIL_UNSOL_INTER_3GPP_IRAT_BASE (RIL_UNSOL_VENDOR_BASE + 60)
#define RIL_UNSOL_INTER_3GPP_IRAT_STATE_CHANGE (RIL_UNSOL_VENDOR_BASE + 61)
/// @}
/// M: [C2K] AP IRAT feature. @{
#define RIL_UNSOL_LTE_BG_SEARCH_STATUS (RIL_UNSOL_VENDOR_BASE + 62)
/// @}

/// M: for GMSS RAT
#define RIL_UNSOL_GMSS_RAT_CHANGED (RIL_UNSOL_VENDOR_BASE + 63)
