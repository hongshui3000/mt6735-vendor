...
#if defined(MTK_AUDIO_NEW_PARAM_SUPPORT)
...
#define BES_LOUDNESS_ACF_L_HPF_FC       168
#define BES_LOUDNESS_ACF_L_HPF_ORDER    4
#define BES_LOUDNESS_ACF_L_BPF_FC       800,600,5000,1000,6000,10000,0,0
#define BES_LOUDNESS_ACF_L_BPF_BW       2000,1300,2000,2000,1000,2000,0,0
#define BES_LOUDNESS_ACF_L_BPF_GAIN     -767,-766,512,512,-765,1536,0,0
#define BES_LOUDNESS_ACF_L_LPF_FC       20000
...
/* Compensation Filter HSF coeffs: default all pass filter       */
    /* BesLoudness also uses this coeffs    */ 
#define BES_LOUDNESS_ACF_L_HPF_FC       250
#define BES_LOUDNESS_ACF_L_HPF_ORDER    4
#define BES_LOUDNESS_ACF_L_BPF_FC       4000,500,2000,10000,8000,9000,0,0
#define BES_LOUDNESS_ACF_L_BPF_BW       2000,284,2000,2000,2000,2000,0,0
#define BES_LOUDNESS_ACF_L_BPF_GAIN     1536,512,1536,1536,1536,1536,0,0
#define BES_LOUDNESS_ACF_L_LPF_FC       20000
