...
#include "camera_AE_PLineTable_gc2755mipi_raw.h"
#include "camera_info_gc2755mipi_raw.h"
...
static void get_flicker_para_by_Preview(FLICKER_CUST_PARA* para)
{
  ...
  FLICKER_CUST_STATISTICS EV50_L60 = {1299, 358, 668, -355};
  FLICKER_CUST_STATISTICS EV60_L50 = {1549, 377, 995, -429};
