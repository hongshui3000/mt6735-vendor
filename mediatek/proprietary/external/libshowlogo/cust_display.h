...
#elif defined(FWVGA) || defined(CU_FWVGA) || defined(CMCC_FWVGA) || defined(CT_FWVGA) || defined(CMCC_LTE_FWVGA) || defined(CT_LTE_FWVGA) || defined(CU_LTE_FWVGA) || defined(Y50B_DEV) || defined(LC_RT_1000)
	// fwvga 480*854
